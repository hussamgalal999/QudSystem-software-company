...
(function () {
  ...
  qudsystem.initialize = {
    init: function () {
      qudsystem.initialize.general();
    },
    general: function () {
  ...
  qudsystem.documentOnReady = {
    init: function () {
      qudsystem.initialize.init();
    },
  };
  $(document).ready(qudsystem.documentOnReady.init);
  $(function () {
